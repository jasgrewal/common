...
Looking back at our stat_summary figure, we have an anomalous sample! The sample `PDX1328` has readings that lie extremely outside the range of the rest of the samples. We can see this more clearly with a boxplot version of the datapoints, plotted using `geom_boxplot()`.  
```{r, eval=TRUE, echo=TRUE, fig.width=6, fig.height=7}
